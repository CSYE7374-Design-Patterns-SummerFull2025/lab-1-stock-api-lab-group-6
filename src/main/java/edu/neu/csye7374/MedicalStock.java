...
public class MedicalStock extends Stock {
    private List<Double> bids = new ArrayList<>();

    public MedicalStock(String name, double price, String description) {
    ...
    public String getMetric() {
        return String.format("Medical Performance Index: %.2f",
